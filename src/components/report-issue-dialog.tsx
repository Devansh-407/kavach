  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      <DialogTrigger asChild>
        <Button variant="outline" className="h-24 rounded-2xl justify-start gap-4 px-6 shadow-lg border-[#0CA196]/20 bg-white dark:bg-[#1E293B] hover:bg-[#0CA196]/5 transition-all group hover:scale-105 min-w-[180px]">
          <div className="p-3 rounded-xl bg-gradient-to-br from-[#F59E0B]/20 to-[#D97706]/20 text-[#F59E0B] group-hover:scale-110 transition-transform shrink-0">
            <Zap className="h-7 w-7" />
          </div>
          <div className="text-left min-w-0 overflow-hidden">
            <p className="font-black text-sm tracking-tight text-[#003E44] dark:text-white">Report Problem</p>
            <p className="text-[9px] font-bold text-[#F59E0B] uppercase tracking-wider leading-tight truncate">Stimulate AI trigger</p>
          </div>
        </Button>
      </DialogTrigger>
