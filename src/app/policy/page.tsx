  ...
  if (error || !dashData?.hasData) {
    return (
      <div className="min-h-screen bg-background flex flex-col items-center justify-center p-6 space-y-4">
        ...
        <Button asChild className="hover:scale-105 transition-transform"><Link href="/onboarding">Get Protected Now</Link></Button>
      </div>
    );
  }
    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="p-6 md:p-12 max-w-6xl mx-auto space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-1000">
        ...
        <Card className="shadow-2xl border-none rounded-3xl bg-white/50 dark:bg-black/20 backdrop-blur-2xl overflow-hidden">
          <CardHeader className="p-8 pb-2 flex flex-row items-center justify-between">
            ...
            <Button 
              ...
              className="rounded-xl gap-2 font-black text-xs uppercase tracking-widest h-11 px-5 hover:scale-105 transition-transform"
            >
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
          <Button variant="outline" asChild className="h-20 rounded-2xl justify-start gap-4 px-6 shadow-xl border-none bg-white dark:bg-black/40 hover:bg-primary/5 transition-all group hover:scale-105">
            <Link href="/claims">
