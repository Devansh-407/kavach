...
import { Users, CloudRain, BarChart3, AlertTriangle, TrendingUp, IndianRupee, MapPin, Zap, Loader2, ThermometerSun, BrainCircuit, Activity, LogOut, Plus, Trash2, Search, Shield } from 'lucide-react';
...
export default function AdminPage() {
  ...
  useEffect(() => {
    ...
    const adminUser = localStorage.getItem('kavachpay_adminUser');
  ...
  const handleSignOut = async () => {
    try {
      ...
      localStorage.removeItem('kavachpay_adminUser');
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
        ...
        <div className="flex items-center gap-4">
          ...
          <div className="flex gap-2 bg-muted/50 dark:bg-muted/10 p-1.5 rounded-[1.25rem] backdrop-blur-md">
            <Button 
              size="sm" 
              className="rounded-xl shadow-lg gap-2 font-black text-xs uppercase tracking-widest px-4 hover:scale-105 transition-transform" 
            ...
            <Button 
              size="sm" 
              variant="secondary"
              className="rounded-xl shadow-lg gap-2 font-black text-xs uppercase tracking-widest px-4 border-none hover:scale-105 transition-transform" 
          ...
          <Button
            size="sm"
            variant="ghost"
            className="rounded-xl gap-2 text-muted-foreground font-bold hover:text-red-500 hover:bg-red-500/10 hover:scale-105 transition-transform"
            ...
            <CardHeader className="p-8 flex flex-row items-center justify-between">
              ...
              <Dialog open={isAddDialogOpen} onOpenChange={setIsAddDialogOpen}>
                <DialogTrigger asChild>
                  <Button className="rounded-xl font-black text-xs uppercase tracking-widest gap-2 h-12 px-6 hover:scale-105 transition-transform">
                ...
                <DialogContent className="rounded-3xl border-none shadow-2xl sm:max-w-md">
                  ...
                  <DialogFooter>
                    <Button onClick={handleAddWorker} className="w-full h-12 rounded-xl font-black uppercase tracking-widest hover:scale-105 transition-transform">Register Partner</Button>
                  </DialogFooter>
                </DialogContent>
              </Dialog>
            </CardHeader>
                    ...
                    <TableRow key={worker.id} className="hover:bg-primary/5 transition-colors border-muted/10">
                      ...
                      <TableCell className="text-right pr-8">
                        <Button 
                          variant="ghost" 
                          size="icon" 
                          className="h-9 w-9 text-muted-foreground hover:text-red-500 hover:bg-red-50 hover:scale-110 transition-transform"
